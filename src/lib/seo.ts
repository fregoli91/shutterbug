export const site = {
  ...
  supportPhone: '(586) 256-5423',
  supportPhoneHref: 'tel:+15862565423',
  amazonStoreUrl: process.env.NEXT_PUBLIC_AMAZON_STORE_URL || 'https://www.amazon.com/shops/shutterbugcamera'
};
