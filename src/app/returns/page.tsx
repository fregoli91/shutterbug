      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {returnSteps.map(([title, copy]) => (
            <article key={title} className="rounded-lg border border-ink/10 bg-white p-6 text-center shadow-sm">
        ...
        <div className="mt-8 grid gap-6 rounded-lg border border-ink/10 bg-cream p-8 shadow-soft lg:grid-cols-2">
          <div>
            <p className="text-center font-serif text-3xl font-bold text-ink">Ready-to-shoot cameras</p>
        ...
        <div className="mt-8 rounded-lg border border-ink/10 bg-white p-6 text-center shadow-sm">
