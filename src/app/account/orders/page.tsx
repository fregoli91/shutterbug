      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            ...
            <h1 className="mt-3 font-serif text-5xl font-bold text-ink">Order history</h1>
          </div>
        ...
        {orders.length ? (
            ...
            {orders.map((order) => (
              <article key={order.id} className="rounded-lg border border-ink/10 bg-white p-6 shadow-sm">
                ...
                <div className="mt-5 grid gap-1 text-sm text-ink/65">
                  ...
                  <p>Shipping status: {order.fulfillmentStatus}</p>
                </div>
          ...
          <div className="mt-8 rounded-lg border border-ink/10 bg-white p-8 text-center shadow-sm">
            <p className="font-serif text-3xl font-bold text-ink">No orders yet</p>
            <p className="mt-3 text-sm leading-6 text-ink/65">Orders tied to your email will appear here after checkout.</p>
